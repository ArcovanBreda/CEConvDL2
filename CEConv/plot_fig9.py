...
x = np.load("outputs/test_results/flowers102-resnet18_3-true-jitter_0_0-split_1_0-seed_0-hsv_space-2024-05-10_11:36:12_imagehueshift_norm.npz")["hue"]
y_norm = np.load("outputs/test_results/flowers102-resnet18_3-true-jitter_0_0-split_1_0-seed_0-hsv_space-2024-05-10_11:36:12_imagehueshift_norm.npz")["acc"]
y_norm_jitter = np.load("outputs/test_results/flowers102-resnet18_3-true-jitter_0_5-split_1_0-seed_0-hsv_space-2024-05-10_12:07:24_imagehueshift_norm_jitter.npz")["acc"]
y_nonorm = np.load("outputs/test_results/flowers102-resnet18_3-true-jitter_0_0-split_1_0-seed_0-hsv_space-no_norm-2024-05-10_12:35:45_imagehueshift_nonorm.npz")["acc"]
y_nonorm_jitter = np.load("outputs/test_results/flowers102-resnet18_3-true-jitter_0_5-split_1_0-seed_0-hsv_space-no_norm-2024-05-10_13:01:58_imagehueshift_nonorm_jitter.npz")["acc"]
